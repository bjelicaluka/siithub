...
export const CommentForm: FC<CommentProps> = ({comment = undefined}) => {
  ...
  const onSubmit = () => {
    ...
    issueDispatcher(isEdit ? instantUpdateComment(issue, executedBy, comment?._id ?? '', textContent) : instantCreateComment(issue, executedBy, textContent));
  }
  return (
    <>
      <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }}>
        <div className="bg-white px-4 py-5 sm:p-6 shadow-md">
          <div className="grid grid-cols-6 gap-2">
            <div className="col-span-2" style={{marginBottom: '-9px', borderStyle: "solid", borderWidth: "1px 1px 0px 1px", borderColor: "#CCCCCC"}}>
